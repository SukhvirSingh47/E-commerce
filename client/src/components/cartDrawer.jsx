    ...
    return (
        <div className="flex flex-col ">
                ...
                <div className="container flex flex-col sm:p-6 p-3 gap-5">
                    {cart.length === 0 ? <EmptyCart /> :
                        cart.map((product, index) => (
                            <div className="flex sm:h-50 h-35 sm:gap-6 bg-[#ececec] md:w-150 w-full justify-between  sm:p-3" key={product._id}>
                                <div className="flex">
                                    ...
                                    <div className="p-2 sm:p-3 md:p-5 truncate ">
                                ...
                                <div className="h-10 w-10 shrink-0 hover:bg-[#dbdbdb8c] flex items-center justify-center rounded-full transition-all duration-400" onClick={() => { setOpen(true); setIndex(index) }}>
                                    <X />
                                </div>
            ...
            <ConfirmModal
                ...
                onConfirm={() => handleRemoveItems(index)}
            />
        </div>
    )
}